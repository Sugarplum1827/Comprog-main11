...
#pragma endregion
	...
	private: System::Void Patient_Information_box_Click(System::Object^ sender, System::EventArgs^ e) {
		try {
				...
				if (reader->Read()) {
					String^ patientInfo = "Name: " + reader["name"]->ToString() + "\r\n" +
						"Age: " + reader["age"]->ToString() + "\r\n" +
						"Address: " + reader["address"]->ToString() + "\r\n" +
						"Phone: " + reader["phone"]->ToString() + "\r\n" +
						"Medical History: " + reader["medical_history"]->ToString();
					Patient_Information_box->Text = patientInfo;
				}
				reader->Close();
			}
			catch (Exception^ ex) {
